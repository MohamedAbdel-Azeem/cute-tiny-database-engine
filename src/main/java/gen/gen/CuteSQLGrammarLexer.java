...
public class CuteSQLGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INTValue", "DOUBLEValue", "StringValue", "CREATE", "INSERT", "INTO", 
			...
			"LessThanEquals", "NotEquals", "GenericSTRING", "A_", "B_", "C_", "D_", 
			"E_", "F_", "G_", "H_", "I_", "J_", "K_", "L_", "M_", "N_", "O_", "P_", 
			"Q_", "R_", "S_", "T_", "U_", "V_", "W_", "X_", "Y_", "Z_", "SPACE"
		};
	}
	...
	public CuteSQLGrammarLexer(CharStream input) {
		super(input);
